...
número fornecido pelo jogador é maior ou menor ao número aleatório. O jogo continuará até que o jogador adivinhe corretamente o número aleatório ou esgote todas as tentativas.
"""
